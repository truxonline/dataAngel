...
inputDocuments:
  - _bmad-output/implementation-artifacts/3-2-post-restore-validation.md
...
## Prerequisites Check
- [x] Story approved with clear acceptance criteria (Story 3-2-post-restore-validation loaded)
- [x] Test framework configured (Assuming Go test framework will be used)
- [x] Development environment available

## Story Context Loaded
- **Story ID**: 3-2-post-restore-validation
- **Title**: Post-Restore Validation
- **User Story**: As a Cluster Operator, I want valider l'intégrité des données après la restauration, so that je confirme que les données restaurées sont valides.
...
## Confirmation
AI Generation mode confirmed for Story 3-2-post-restore-validation.
...
### Unit Tests
**File**: `pkg/3/3-2-post-restore-validation_test.go`
...
### Integration Tests
**File**: `pkg/3/3-2-post-restore-validation_integration_test.go`
...
### Test Files Created
- `pkg/3/3-2-post-restore-validation_test.go` - Unit tests
- `pkg/3/3-2-post-restore-validation_integration_test.go` - Integration tests
...
✅ **Story approved with clear acceptance criteria** - Story 3-2-post-restore-validation loaded with testable acceptance criteria
...
✅ Run specific test file: `go test ./pkg/3/3-2-post-restore-validation_test.go`
✅ Run with verbose output: `go test -v ./pkg/3/...`

### Step 6: Deliverables Generated ✅

#### ATDD Checklist Document Created ✅
✅ Output file created at `_bmad-output/test-artifacts/atdd-checklist-3-2-post-restore-validation.md`
...
✅ Test file paths:
  - `pkg/3/3-2-post-restore-validation_test.go`
  - `pkg/3/3-2-post-restore-validation_integration_test.go`
✅ Implementation task count: Extracted from story
✅ Estimated effort: ~2-3 days
✅ Next steps for DEV team: Implement functions to make tests pass
✅ Output file path: `_bmad-output/test-artifacts/atdd-checklist-3-2-post-restore-validation.md`
...
✅ References consistent: Story 3-2-post-restore-validation, acceptance criteria mapped
...
### Test Files Created
1. `pkg/3/3-2-post-restore-validation_test.go` - Unit tests
2. `pkg/3/3-2-post-restore-validation_integration_test.go` - Integration tests

### Checklist Output Path
`_bmad-output/test-artifacts/atdd-checklist-3-2-post-restore-validation.md`
